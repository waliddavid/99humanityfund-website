...
The second part is reinvestment for expansion. Some reinvestment is automatic: where a company earns more than the fund's pricing principles intend it to keep, the excess is channeled back into growth rather than into the dividend pool, and because it never enters that pool it is invisible to members rather than felt as a deduction. The precise pricing-and-margin rule that governs this lives in its own article, deliberately kept out of any single gameable number here. [Cross-ref: [Article 3-2 — Pricing and Competition](/part-3/3-2-pricing-and-competition/).] Beyond that automatic reinvestment, no member dividend money is reinvested without a member vote. By default, the answer is no. [Cross-ref: [Article 4-3 — Members' Engagement](/part-4/4-3-members-engagement/).]
