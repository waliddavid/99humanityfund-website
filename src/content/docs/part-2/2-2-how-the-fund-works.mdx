...
description: "Here is the whole idea in one sentence: people everywhere contribute a dollar a month, the fund uses the money to buy and build real companies and banks to strengthen local economies and compete with …"
template: splash
prev:
...
Here is the whole idea in one sentence: people everywhere contribute a dollar a month, the fund uses the money to buy and build real companies and banks to strengthen local economies and compete with global companies to gradually bring prices down, and the fund's profits are owned equally by everyone who joined. That is the fund. Everything else — the governance, the bank, the industries, the long timeline — is detail hanging off that single frame.

This article explains how that frame actually works: how the money comes in, how it grows, who owns what, and how a movement that starts small could, over a lifetime, come to be owned by most of humanity.

## The dollar, and what it buys

A member contributes one dollar a month. In return they receive one equal share of the fund — not a share sized to how much they paid, because everyone pays the same dollar, but an equal share of the whole: equal ownership, equal dividends, and one equal vote. A member in a village and a member in a capital city hold exactly the same stake. This equality is not a slogan; it is the architectural rule the entire institution is built to protect.

The dollar is deliberately small — small enough that, in a wealthy country, it is beneath noticing, less than the cost of a coffee you forget you bought. But multiplied across hundreds of millions of people, month after month, it becomes one of the largest and most predictable pools of capital in the world: money that arrives not from investors expecting to be served first, but from ordinary people who will own what it builds.
