...
The complete analysis (194 countries × 30 categories × 5 scenarios) is available as downloadable data and a full methodology. See [6.2 — Methodology and Findings] (/part-6/methodology/), [6.3 — Five-Scenario Comparison Data](/part-6/data-five-scenario-comparison/), and [6.4 — Phased Implementation Data](/part-6/data-phased- implementation/). Sources include UN WPP, ILO ILOSTAT, UN Comtrade, UNIDO INDSTAT, World Bank WGI/LPI, USGS, Energy Institute, and UNESCO UIS, all consulted as of May 2026.
