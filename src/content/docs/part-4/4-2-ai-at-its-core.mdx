...
**Vote integrity.** Independent instances cross-count every vote and must match; anonymized votes post to a public ledger anyone can tally; there is no exportable personal receipt that could enable coercion. As a personal backstop, a member may verify their own vote inside a supervised, observation-proof facility where they unlock and read their *own* encrypted record — the booth never tells them their vote, so there is nothing in it to compromise. Losing your device costs the ability to re-verify, never the vote itself.
