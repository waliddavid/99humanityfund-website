...
description: "A 25-year plan to move 41 million manufacturing jobs from over-concentrated countries to where they are needed most — seeking fairer job distribution without dismantling anyone's economy."
template: splash
prev:
...
<div class="article-hero">
  <img src="/cards/part-3-1.jpg" alt="A world map with manufacturing redistributed toward regions where jobs are needed most." />
</div>
...
This is Part 3 of the New World Order. Part 1 proposed a \$1 monthly contribution into a global investment fund that would eventually pay everyone a dividend from the companies it owns. That Part 1 stayed at the level of "what if everyone had a basic floor of income as a survival income?"

This post is harder. It asks: even with a global dividend, how do we make a fair distribution of jobs for those wanting a higher income aside from their survival income? Currently many jobs are concentrated in a few regions, which would only give the opportunity of higher income to those who live close by. The Global Fund Companies should be in various regions and in countries where more jobs are needed.
...
And here's the thing the consumer-cost framing misses: **concentration is fragile.**
...
<table class="data-table">
  <thead>
    <tr><th>Scenario</th><th>What it optimizes for</th><th>How aggressive</th></tr>
  </thead>
  <tbody>
    <tr><td>Equity-leaning</td><td>Allocation matches working-age population share as closely as possible</td><td>Moves 176M jobs</td></tr>
    <tr><td>Balanced</td><td>Fair working-age population share + existing competitive advantages + capability to absorb new jobs</td><td>Moves 151M jobs</td></tr>
    <tr><td>Efficiency-leaning</td><td>Reward existing competitive producers; minimize disruption</td><td>Moves 129M jobs</td></tr>
    <tr><td>Unemployment-Leveling</td><td>Bring countries with high official unemployment down to &#126;10%</td><td>Moves 9M jobs</td></tr>
    <tr><td>Informal Insertion</td><td>Help countries with high official unemployment <em>and</em> with large informal-manufacturing pools</td><td><strong>Moves 41M jobs</strong></td></tr>
  </tbody>
</table>
...
That's **Informal Insertion**. Here's what it does and why.
...
<table class="data-table">
  <thead>
    <tr><th>Demand source</th><th>Volume</th></tr>
  </thead>
  <tbody>
    ...
    <tr><td><strong>Absorbable after 6%/year cap</strong></td><td><strong>40.6M jobs</strong></td></tr>
  </tbody>
</table>
...
<table class="data-table">
  <thead>
    <tr><th>Region</th><th>2027 mfg jobs</th><th>2056 mfg jobs</th><th>Change</th></tr>
  </thead>
  <tbody>
...
It might sound scary for a country to be asked to reduce their manufacturing jobs so another country with a greater need can absorb them. However, remember that our proposal is for the global fund to own most of those factories, and the global fund is owned by its investors who would hopefully be the entire global population. If people have a minimum income received by the fund's dividends, then their basic needs could be met so no person anywhere is in extreme poverty.

Another revenue stream would be royalties: the fund pays inventors and innovators a share of profits when their ideas are commercialized through fund-owned companies. This rewards people for contributing new products and processes to the global productive system, complementing the universal dividend with a merit-based payment for innovation (see Part 1 and Part 2 for details).

A government would redirect its social efforts by encouraging innovation or dividing the day shift so people can work half of the time and allowing others to work the other half. The off time promotes more family and leisure time or time to be used in creative ideas that can bring royalties.

**Half-shifts (work-sharing).** The German "Kurzarbeit" model: convert some full-time positions into two-person half-shifts. Two workers each willing to work half the hours, with the income gap covered by other revenue streams like royalties or the dividends from the global fund. This doubles the employed headcount in those positions. People work less but more people work.
...
**China** goes from 215M manufacturing workers in 2027 to 186M in 2056. That's a 14% reduction over 29 years — about **0.5% per year**, slower than China's working-age population is shrinking due to aging. In real terms: this isn't a contraction so much as natural attrition.
...
Five years of planning, then five 5-year tranches. Most diffuse industries first; most concentrated last.

<table class="data-table">
  <thead>
    <tr><th>Period</th><th>What happens</th></tr>
  </thead>
  <tbody>
    <tr><td>2027–2031</td><td>Global Fund consolidation. Hiring Experts from each Country Worldwide. Relocation Planning phase. International Citizens agreements, training infrastructure, transition support funds, baseline data agreements.</td></tr>
    <tr><td>2031–2036 (Tranche 1)</td><td>Cargo vehicles, ores, processed food, wood products, furniture, jewelry. <em>(Most diffuse industries — easiest to redistribute.)</em></td></tr>
    <tr><td>2036–2041 (Tranche 2)</td><td>Paper, hybrid vehicles, <strong>textiles</strong>, specialty chemicals, energy products, aerospace.</td></tr>
    <tr><td>2041–2046 (Tranche 3)</td><td>Misc. manufactures, tobacco/feed, base metals, <strong>plastics &amp; basic chemicals</strong>, aluminum, vehicle parts.</td></tr>
    <tr><td>2046–2051 (Tranche 4)</td><td>Steel, combustion vehicles, cement, footwear, solar/wind, <strong>pharmaceuticals</strong>.</td></tr>
    <tr><td>2051–2056 (Tranche 5)</td><td>Optical/medical, <strong>industrial machinery</strong>, batteries, <strong>consumer electronics</strong>, <strong>EVs</strong>, <strong>semiconductors</strong>. <em>(Most concentrated — needs the longest runway.)</em></td></tr>
  </tbody>
</table>
...
<table class="data-table">
  <thead>
    <tr><th>Country</th><th>Current Jobs (2027)</th><th>Informal Insertion Scenario (2056)</th><th>Balanced Scenario (2056)</th></tr>
  </thead>
  <tbody>
    <tr><td>China</td><td>215M</td><td>186M</td><td><strong>72M</strong></td></tr>
    <tr><td>India</td><td>60M</td><td>70M</td><td><strong>108M</strong></td></tr>
...
The contraction in China's last tranche (2051–2056) would hit **-10.2% per year**. That would be a level of churn historically associated with crises, not policy.
...
- **Sectoral capability scores are imperfect.** A country's "capability" to do semiconductor manufacturing in 2027 isn't the same as in 2056. The model assumes capability is roughly persistent over 25 years, which isn't quite right but probably isn't wildly wrong either.
...
The \$1 Global Fund (Part 1) is the financial backbone: every person on Earth, from birth, participates in a fund that contributes \$1/month and pays back dividends from its accumulated ownership of global productive capacity. Manufacturing redistribution (Part 3) is how the fund makes sure the jobs that produce that global fund dividends exist where people actually live, not just where production happens to be cheapest.

The complete analysis (194 countries × 30 categories × 5 scenarios) is available as downloadable data and a full methodology. See [Article 3-2 — Methodology and Findings](/part-3/methodology/), [Article 3-3 — Five-Scenario Comparison Data](/part-3/data-five-scenario-comparison/), and [Article 3-4 — Phased Implementation Data](/part-3/data-phased-implementation/). Sources include UN WPP, ILO ILOSTAT, UN Comtrade, UNIDO INDSTAT, World Bank WGI/LPI, USGS, Energy Institute, and UNESCO UIS, all consulted as of May 2026.

**About this series:** *The New World Order: \$1 Revolution* proposes a global investment fund every human participates in from birth — citizen-owned, democratically governed, and structured to gradually replace extractive global capitalism with mission-driven citizen-owned production. This post addresses where the fund's owned companies' jobs should be. Future posts address how the fund competes, what it owns, how prices change, and how to get from today to there.

**What's next:** *Part 4 will cover pricing, consumer welfare, and the wage-convergence mechanism. Part 5 will explore service-sector redistribution and the half-shift work-sharing scheme in depth. Part 6 will address the transition path: pilot regions, treaties, political coalitions. Part 7 will engage with the strongest critiques and failure modes.*
